...
namespace Abodit.Units.Tests.Graph
{
    public class SampleNode : INodeProbability<Person>, IEquatable<SampleNode>, IDotGraphNode
    {
        ...
        public bool Equals(SampleNode? other) => other is SampleNode s && this.Id == s.Id;

        public override bool Equals(object? obj) => Equals(obj as SampleNode);

        public override int GetHashCode() => this.ProbabilitySet.GetHashCode();
    }
}